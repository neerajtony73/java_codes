...
public class Driver {
	...
	public static void main(String[] args) {
		...
		//c[1]=new College_Student("Neeraj" ,true,20,"223-445-233","129p",3.5,"computer science","A");
		...
		co[1]=new Course(p[1],c1,"Computer Networking");
		
		Course[] co1=new Course[2];
		co1[0]=new Course(q[0],c1,"Computer Architecture");
		co1[1]=new Course(q[1],c,"Artificial Intelligence");
		
		// int count=0;
		//~ for(int i=0;i<co.length;i++){
		if(co[0].equals(co[1])==true){
			System.out.println("fatal error");
			System.exit(0);
		}
		if(co1[0].equals1(co1[1])==true){
			System.out.println("fatal error");
			System.exit(0);
		}
